...
#ifndef PROJECTC_H_INCLUDED
#define PROJECTC_H_INCLUDED
...
#include "progShader.h"          // Classes for GLSL programmable-shaders.
...
void drawBush(void);  // Draw a 3D bush
void drawSun(void);   // Draw a 3D sun
void drawRobot(void); // Draw a 3D robot
