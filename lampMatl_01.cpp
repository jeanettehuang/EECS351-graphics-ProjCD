...
// Use matlType to select one of our pre-defined kinds of openGL material.
{
    ...
    case MATL_BRASS:
        ...
        K_spec.put(0.992157, 0.941176, 0.807843, 1.0);
        K_shiny = 27.8974f;
    ...
    case MATL_BRONZE_DULL:
        ...
        K_spec.put(0.393548, 0.271906, 0.166721, 1.0);
        K_shiny = 25.6f;
    ...
    case MATL_BRONZE_SHINY:
        ...
        K_spec.put(0.774597, 0.458561, 0.200621, 1.0);
        K_shiny = 76.8f;
    ...
    case MATL_CHROME:
        ...
        K_spec.put(0.774597, 0.774597, 0.774597, 1.0);
        K_shiny = 76.8f;
    ...
    case MATL_COPPER_DULL:
        ...
        K_spec.put(0.256777, 0.137622, 0.086014, 1.0);
        K_shiny = 12.8f;
    ...
    case MATL_COPPER_SHINY:
        ...
        K_spec.put(0.580594, 0.223257, 0.0695701, 1.0);
        K_shiny = 51.2f;
        strncpy(matlName, "MATL_COPPER_SHINY", MATL_STRMAX);  // set text label
        break;
    case MATL_GOLD_DULL:
        K_emit.put(0.0,      0.0,      0.0,      1.0);
        K_ambi.put(0.64725,  0.5995,   0.0745,   1.0);
        K_diff.put(0.75164,  0.60648,  0.22648,  1.0);
        K_spec.put(0.628281, 0.555802, 0.366065, 1.0);
        K_shiny = 51.2f;
        strncpy(matlName, "MATL_GOLD_DULL", MATL_STRMAX);  // set text label
        break;
    case MATL_ORANGE:
        K_emit.put(0.0,      0.0,      0.0,      1.0);
        K_ambi.put(0.64725,  0.2995,   0.0745,   1.0);
        K_diff.put(0.75164,  0.60648,  0.22648,  1.0);
        K_spec.put(0.628281, 0.555802, 0.366065, 1.0);
        K_shiny = 51.2f;
        strncpy(matlName, "MATL_ORANGE", MATL_STRMAX);  // set text label
        break;
    case MATL_GOLD_SHINY:
        K_emit.put(0.0,      0.0,      0.0,      1.0);
        K_ambi.put(0.24725,  0.2245,   0.0645,   1.0);
        K_diff.put(0.34615,  0.3143,   0.0903,   1.0);
        K_spec.put(0.797357, 0.723991, 0.208006, 1.0);
        K_shiny = 83.2f;
    ...
    case MATL_PEWTER:
        ...
        K_spec.put(0.333333, 0.333333, 0.521569, 1.0);
        K_shiny = 9.84615f;
    ...
    case MATL_SILVER_DULL:
        ...
        K_spec.put(0.508273, 0.508273, 0.508273, 1.0);
        K_shiny = 51.2f;
    ...
    case MATL_SILVER_SHINY:
        ...
        K_spec.put(0.773911, 0.773911, 0.773911, 1.0);
        K_shiny = 89.6f;
    ...
    case MATL_EMERALD:
        ...
        K_spec.put(0.633,   0.727811, 0.633,   0.55);
        K_shiny = 76.8f;
    ...
    case MATL_JADE:
        ...
        K_spec.put(0.316228, 0.316228, 0.316228, 0.95);
        K_shiny = 12.8;
    ...
    case MATL_OBSIDIAN:
        ...
        K_spec.put(0.332741, 0.328634, 0.346435, 0.82);
        K_shiny = 38.4;
    ...
    case MATL_WHITE:
        K_emit.put(0.0,      0.0,      0.0,      1.0);
        K_ambi.put(0.95,     0.91725,  0.91725,  0.922);
        K_diff.put(1.0,      0.929,    0.929,    0.922);
        K_spec.put(0.296648, 0.996648, 0.996648, 0.922);
        K_shiny = 11.264f;
        strncpy(matlName, "MATL_WHITE", MATL_STRMAX);
        break;
    case MATL_RUBY:
        K_emit.put(0.0,      0.0,      0.0,      1.0);
        K_ambi.put(0.1745,   0.01175,  0.01175,  0.55);
        K_diff.put(0.61424,  0.04136,  0.04136,  0.55);
        K_spec.put(0.727811, 0.626959, 0.626959, 0.55);
        K_shiny = 76.8f;
    ...
    case MATL_TURQUOISE:
        ...
        K_spec.put(0.297254, 0.30829,  0.306678, 0.8);
        K_shiny = 12.8f;
...
// being rendered.
{
    ...
    if(isTwoSided==true) myFace = GL_FRONT_AND_BACK;
    else myFace = GL_FRONT;
